...
class SaleOrderLine(models.Model):
    ...
    @api.depends('product_uom_qty', 'discount', 'price_unit', 'tax_id','weight')
    def _compute_amount(self):
        ...
        for line in self:
            ...
            if line.product_uom_qty>0:
                amount_untaxed = amount_untaxed/line.product_uom_qty
                amount_tax = amount_tax/line.product_uom_qty
            amount_untaxed = amount_untaxed*line.weight
            amount_tax = amount_tax*line.weight
            line.update({
