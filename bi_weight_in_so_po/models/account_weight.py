...
class AccountMoveLine(models.Model):
    ...
    @api.depends('quantity', 'discount', 'price_unit', 'tax_ids', 'currency_id','weight')
    def _compute_totals(self):
        for line in self:
            ...
            if line.tax_ids:
                ...
                if line.quantity>0:
                    price_subtotal = line.price_subtotal/line.quantity
                    price_total = line.price_subtotal/line.quantity
                    line.price_subtotal = price_subtotal*line.weight
                    line.price_total = price_total*line.weight
            else:
